...
$conf['logo'] = (!empty($dados['logo']) ? json_decode($dados['logo'], true)[0]['image'] : "");
$conf['favicon'] = (!empty($dados['favicon']) ? json_decode($dados['favicon'], true)[0]['image'] : HOME . "image/" . VENDOR . "config/public/assets/favicon.png");
$conf['ssl'] = SSL;
$conf['www'] = WWW;
$conf['home'] = HOME;
