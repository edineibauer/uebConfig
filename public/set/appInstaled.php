...
if(file_exists(PATH_HOME . "_config/appInstall/appInstaled.json"))
    $dados = json_decode(file_get_contents(PATH_HOME . "_config/appInstall/appInstaled.json"), !0);

$dados[($ios ? "ios" : "android")]++;

$f = fopen(PATH_HOME . "_config/appInstall/appInstaled.json", "w");
