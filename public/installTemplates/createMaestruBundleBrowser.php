...
if(file_exists(PATH_HOME . VENDOR . "config/public/installTemplates/htaccessBrowser.txt"))
    Config::createFile(PATH_HOME . "cordova/platforms/browser/www/.htaccess", file_get_contents(PATH_HOME . VENDOR . "config/public/installTemplates/htaccessBrowser.txt"));