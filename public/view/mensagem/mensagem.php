<div id="frame">
    <div class="content">
        <section class="message">
            <div id="mensagemHeader" data-template="mensagemHeader"></div>
    ...
    <div class="message-input" style="display: block">
        <div class="wrap">
            ...
            <input class="hide" id="anexo" type="file" multiple max="10" accept="*" />

            <label for="anexo" class="material-icons" style="padding: 9px 13px;">link</label>
...
<section id="modalPreviewFile">
    <div class="previewFileCard">
        <header>
            <button class="closeModal btn">
                <i class="material-icons">arrow_back</i>
                <div class="left" id="modalTitle"></div>
            </button>
            <a target="_blank" download class="downloadModal">
...
<div class="hide">
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        <symbol id="doc" viewBox="0 0 56 56"><title>Documento</title>
        ...
        <symbol id="docx" viewBox="0 0 56 56"><title>Documento</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#8697CB;"
        ...
        <symbol id="pdf" viewBox="0 0 56 56"><title>pdf</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="xls" viewBox="0 0 56 56"><title>Excel</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#91CDA0;"
                  d="M48.037,56H7.963C7.155,56,6.5,55.345,6.5,54.537V39h43v15.537C49.5,55.345,48.845,56,48.037,56z"/>
            <g>
                <path style="fill:#FFFFFF;"
        ...
        <symbol id="xlsx" viewBox="0 0 56 56"><title>Excel</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#91CDA0;"
        ...
        <symbol id="ppt" viewBox="0 0 56 56"><title>Apresentação</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#F6712E;"
                  d="M48.037,56H7.963C7.155,56,6.5,55.345,6.5,54.537V39h43v15.537C49.5,55.345,48.845,56,48.037,56z"/>
            <g>
                <path style="fill:#FFFFFF;"
        ...
        <symbol id="pptx" viewBox="0 0 56 56"><title>Apresentação</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#F6712E;"
        ...
        <symbol id="zip" viewBox="0 0 56 56"><title>Compactado</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="rar" viewBox="0 0 56 56"><title>RAR</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <g>
                <rect x="26.5" y="42" style="fill:#C8BDB8;" width="2" height="14"/>
                <polygon style="fill:#C8BDB8;"
                         points="30.5,23 30.5,21 28.5,21 28.5,19 26.5,19 26.5,21 24.5,21 24.5,23 26.5,23 26.5,25 24.5,25 24.5,27 26.5,27 26.5,29 24.5,29 24.5,31 26.5,31 26.5,34 28.5,34 28.5,31 30.5,31 30.5,29 28.5,29 28.5,27 30.5,27 30.5,25 28.5,25 28.5,23 "/>
            </g>
            <g>
        ...
        <symbol id="file" viewBox="0 0 56 56"><title>Arquivo</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#C8BDB8;"
        ...
        <symbol id="search" viewBox="0 0 56 56"><title>Busca</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <g>
                ...
                <path style="fill:#556080;"
                      d="M25.5,36c-6.065,0-11-4.935-11-11s4.935-11,11-11s11,4.935,11,11S31.565,36,25.5,36z M25.5,16 c-4.963,0-9,4.037-9,9s4.037,9,9,9s9-4.037,9-9S30.463,16,25.5,16z"/>
            </g>
            <path style="fill:#556080;"
                  d="M42.5,45c-0.256,0-0.512-0.098-0.707-0.293l-11-11c-0.391-0.391-0.391-1.023,0-1.414 s1.023-0.391,1.414,0l11,11c0.391,0.391,0.391,1.023,0,1.414C43.012,44.902,42.756,45,42.5,45z"/>
            <path style="fill:#D1D4D1;"
                  d="M25.5,22h-6c-0.553,0-1-0.447-1-1s0.447-1,1-1h6c0.553,0,1,0.447,1,1S26.053,22,25.5,22z"/>
            <path style="fill:#D1D4D1;"
                  d="M30.5,22h-2c-0.553,0-1-0.447-1-1s0.447-1,1-1h2c0.553,0,1,0.447,1,1S31.053,22,30.5,22z"/>
            <path style="fill:#D1D4D1;"
                  d="M24.5,30h-2c-0.553,0-1-0.447-1-1s0.447-1,1-1h2c0.553,0,1,0.447,1,1S25.053,30,24.5,30z"/>
            <path style="fill:#D1D4D1;"
                  d="M30.5,30h-2c-0.553,0-1-0.447-1-1s0.447-1,1-1h2c0.553,0,1,0.447,1,1S31.053,30,30.5,30z"/>
            <path style="fill:#D1D4D1;"
                  d="M23.5,26h-4c-0.553,0-1-0.447-1-1s0.447-1,1-1h4c0.553,0,1,0.447,1,1S24.053,26,23.5,26z"/>
            <path style="fill:#D1D4D1;"
                  d="M32.5,26h-5c-0.553,0-1-0.447-1-1s0.447-1,1-1h5c0.553,0,1,0.447,1,1S33.053,26,32.5,26z"/>
        </symbol>
        <symbol id="txt" viewBox="0 0 56 56"><title>Texto</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="json" viewBox="0 0 56 56"><title>Json</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="js" viewBox="0 0 56 56"><title>JavaScript</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="iso" viewBox="0 0 56 56"><title>ISO</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="css" viewBox="0 0 56 56"><title>CSS</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#0096E6;"
        ...
        <symbol id="html" viewBox="0 0 56 56"><title>HTML</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="xml" viewBox="0 0 56 56"><title>XML</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="svg" viewBox="0 0 56 56"><title>SVG</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
        ...
        <symbol id="avi" viewBox="0 0 56 56"><title>AVI</title>
            <path style="fill:#E9E9E0;"
                  d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
            <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12 "/>
            <path style="fill:#D75E72;"
                  d="M48.037,56H7.963C7.155,56,6.5,55.345,6.5,54.537V39h43v15.537C49.5,55.345,48.845,56,48.037,56z"/>
            <g>
                <path style="fill:#FFFFFF;"
                      d="M16.361,53l3.527-10.063h1.627L25.016,53H23.32l-0.725-2.092h-3.787L18.07,53H16.361z M19.191,49.801h3.008l-1.49-4.348L19.191,49.801z"/>
                <path style="fill:#FFFFFF;"
